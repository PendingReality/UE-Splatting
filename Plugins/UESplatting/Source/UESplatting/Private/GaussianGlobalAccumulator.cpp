...
void FGaussianGlobalAccumulator::ResizeIfNeeded(FRHICommandListBase& RHICmdList, uint32 NewTotalCount)
{
	...
	UE_LOG(LogUESplatting, Verbose, TEXT("GaussianGlobalAccumulator: Resizing from %u to %u splats (%u tiles)"),
...
void FGaussianGlobalAccumulator::EnsureCompactionBuffersAllocated(FRHICommandListBase& RHICmdList)
{
	...
	UE_LOG(LogUESplatting, Verbose, TEXT("GaussianGlobalAccumulator: Allocating compaction prefix-sum buffers (MaxProxies=%u)"), MAX_PROXY_COUNT);
