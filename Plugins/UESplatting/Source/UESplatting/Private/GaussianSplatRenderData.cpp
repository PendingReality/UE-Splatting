...
void FGaussianSplatRenderData::Initialize(UGaussianSplatAsset* Asset)
{
	...
	UE_LOG(LogUESplatting, Verbose, TEXT("GaussianSplatRenderData: Created shared CPU data for asset '%s' (%d splats)"),
...
void FGaussianSplatRenderData::CreateGPUBuffers(FRHICommandListBase& RHICmdList)
{
	...
	UE_LOG(LogUESplatting, Verbose, TEXT("GaussianSplatRenderData: Created %d shared GPU buffers for asset '%s'"),
